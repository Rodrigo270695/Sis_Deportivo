...
public class TipoProfesionalController implements CRUD{
    ...
    public List listar(){
        ...
        try {
            ...
            while (rs.next()) {
                ...
                tipoProfesional.setDescripcion(rs.getString(2));
    ...
    public void registrar(Object obj) throws Exception {
        ...
        sql = "INSERT INTO tipo_profesional(descripcion,abreviatura) VALUES(?,?)";

        try {

            con = estado.conectar();
            ps = con.prepareStatement(sql);
            ps.setString(1, tipoProfesional.getDescripcion());
    ...
    public void modificar(Object obj) throws Exception {
        ...
        TipoProfesional tipoProfesional = (TipoProfesional) obj;
        sql = "UPDATE tipo_profesional SET descripcion=?,abreviatura=? WHERE tipo_profesional_id = ?";
