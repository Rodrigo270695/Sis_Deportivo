...
public class FrmGestionarRol extends javax.swing.JInternalFrame {
    ...
    public static void listar(String texto) {
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            ImageIcon iconoPerm = new ImageIcon("src/com/deportivo/iconos/check.png");
        ...
        tblListado.getColumnModel().getColumn(1).setPreferredWidth(365);
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        ModalRegistrarRol frm = new ModalRegistrarRol();
                ...
                switch (boton.getName()) {
                    ...
                    case "btnModificar" -> {
                        if (filas == 0) {//si no elije ninguna fila
                            ...
                            ModalRegistrarRol.idRol = id;
                            FrmMenuPrincipal.centrarVentana(new ModalRegistrarRol());
