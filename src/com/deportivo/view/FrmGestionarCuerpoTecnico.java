...
import com.deportivo.view.modal.ModalRegistrarCuerpoTecnico;
...
public class FrmGestionarCuerpoTecnico extends javax.swing.JInternalFrame {

    public static CuerpoTecnicoController cuerpoTecnicoC = new CuerpoTecnicoController();
    
    public FrmGestionarCuerpoTecnico() {
        initComponents();
        listar("");
    }
    ...
    public static void listar(String texto) {
        ...
        if (txtBuscar.getText().length() == 0) {
            lista = cuerpoTecnicoC.listar();
        } else {
            lista = cuerpoTecnicoC.buscar(texto);
        }
        Object obj[] = new Object[5];

        for (int i = 0; i < lista.size(); i++) {
            cuerpoTecnico = (CuerpoTecnico) lista.get(i);
            obj[0] = cuerpoTecnico.getCuerpoTecnicoId();
            obj[1] = cuerpoTecnico.getNombre();
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        ModalRegistrarCuerpoTecnico frm = new ModalRegistrarCuerpoTecnico();
                ...
                switch (boton.getName()) {
                    case "btnEliminar" -> {
                        if (filas == 0) {//si no elije ninguna fila
                            Alerta alerta = new Alerta("Alerta", "Debe seleccionar un cuerpoTecnico");
                        } else {
                    ...
                    case "btnModificar" -> {
                        if (filas == 0) {//si no elije ninguna fila
                            ...
                            ModalRegistrarCuerpoTecnico.idCuerpoTecnico = id;
                            FrmMenuPrincipal.centrarVentana(new ModalRegistrarCuerpoTecnico());
                            ModalRegistrarCuerpoTecnico.btnGrabar.setText("Modificar");
                    ...
                    case "btnVer" -> {
                        if (filas == 0) {
                            ...
                            ModalRegistrarCuerpoTecnico.vista = true;
                            ModalRegistrarCuerpoTecnico.idCuerpoTecnico = id;
                            FrmMenuPrincipal.centrarVentana(new ModalRegistrarCuerpoTecnico());
                        }
                    }
