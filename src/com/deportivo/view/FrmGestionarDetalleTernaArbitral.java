...
import com.deportivo.view.modal.ModalRegistrarDetalleTernaArbitral;
import com.deportivo.vista.modal.alerts.*;
import java.awt.*;
import javax.swing.*;
import javax.swing.table.DefaultTableModel;

public class FrmGestionarDetalleTernaArbitral extends javax.swing.JInternalFrame {

    public static DetalleTernaArbitralController detalleC = new DetalleTernaArbitralController();
    TipoTernaArbitralController tipoC = new TipoTernaArbitralController();
    public static int idProfesional;

    public FrmGestionarDetalleTernaArbitral() {
        initComponents();
        listar("");
    }
    ...
    public static void listar(String texto) {
        ...
        String columas[] = {"TIPO TERNA ARBITRAL", ""};
        ...
        DetalleTernaArbitral detallePro = null;
        TipoTernaArbitral tipoP;
...
//            lista = detalleC.buscar(texto);
        ...
        for (int i = 0; i < detallePro.getTipoTernaArbitral().size(); i++) {
            tipoP = detallePro.getTipoTernaArbitral().get(i);
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("GESTIONAR DETALLE TERNA ARBITRAL");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        ModalRegistrarDetalleTernaArbitral.idProfesional = idProfesional;
        ModalRegistrarDetalleTernaArbitral frm = new ModalRegistrarDetalleTernaArbitral();
                    ...
                    case "btnEliminar" -> {
                        if (filas == 0) {//si no elije ninguna fila
                            ...
                            if (opcion == 0) {
                                ...
                                TipoTernaArbitral tipoP = (TipoTernaArbitral) tipoC.obtenerdato(valor);
                                
                                try {
                                    detalleC.eliminarDetalle(idProfesional,tipoP.getTipo_terna_arbitral_id());
