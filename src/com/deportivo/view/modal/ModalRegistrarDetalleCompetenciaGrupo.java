...
import com.deportivo.view.FrmGestionarDetalleCompetenciaGrupo;
import com.deportivo.vista.modal.alerts.*;
import java.awt.Toolkit;
import java.util.List;

public final class ModalRegistrarDetalleCompetenciaGrupo extends javax.swing.JInternalFrame {

    DetalleCompetenciaGrupoController detalleC = new DetalleCompetenciaGrupoController();
    CompetenciaController profesionalC = new CompetenciaController();
    GrupoController tipoC = new GrupoController();

    public static int idProfesional;

    public ModalRegistrarDetalleCompetenciaGrupo() {
        initComponents();
    ...
    void cargarTipoProfesionales() {
        ...
        List<Grupo> lista = tipoC.listar();

        for (Grupo tipoPro : lista) {
    ...
    void grabar() {
        ...
        Grupo tipoP = (Grupo) tipoC.obtenerdato(cbxTipo.getSelectedItem().toString());

        try {
            detalleC.registrarDetalle(idProfesional, tipoP.getGrupoId());
            AlertaBien bien = new AlertaBien("Mensaje", "Se registró correctamente el detaelle de profesional");
            FrmGestionarDetalleCompetenciaGrupo.listar("");
            dispose();
        } catch (Exception e) {
