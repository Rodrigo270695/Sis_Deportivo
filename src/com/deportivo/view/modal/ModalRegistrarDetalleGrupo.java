...
import com.deportivo.view.FrmGestionarDetalleGrupo;
...
public final class ModalRegistrarDetalleGrupo extends javax.swing.JInternalFrame {
    ...
    void grabar() {
        ...
        try {
            detalleGC.registrarDetalle(idGrupo, equipo.getEquipoId());
            FrmGestionarDetalleGrupo.listar("");
            AlertaBien bien = new AlertaBien("MENSAJE", "Se agregó correctamente el equipo al grupo");
            dispose();
