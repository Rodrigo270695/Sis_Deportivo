...
public final class ModalRegistrarDetalleGrupo extends javax.swing.JInternalFrame {

   DetalleGrupoController detalleC = new DetalleGrupoController();
    GrupoController profesionalC = new GrupoController();
    EquipoController tipoC = new EquipoController();

    public static int idGrupo;

    public ModalRegistrarDetalleGrupo() {
        initComponents();
        cargarEquipoes();
    }
    ...
    void cargarEquipoes() {
        ...
        List<Equipo> lista = tipoC.listar();

        for (Equipo equipo : lista) {
            cbxTipo.addItem(equipo.getNombreCompleto());
        }
...
//    void grabar() {
//
//        Equipo tipoP = (Equipo) tipoC.obtenerdato(cbxTipo.getSelectedItem().toString());
//
//        try {
//            detalleC.registrarDetalle(idGrupo, tipoP.getEquipoId());
//            AlertaBien bien = new AlertaBien("Mensaje", "Se registró correctamente el detaelle de profesional");
//            FrmGestionarDetalleGrupo.listar("");
//            dispose();
//        } catch (Exception e) {
...
//    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("REGISTRAR DETALLE GRUPO");
