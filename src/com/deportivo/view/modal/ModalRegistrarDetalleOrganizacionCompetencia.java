...
public final class ModalRegistrarDetalleOrganizacionCompetencia extends javax.swing.JInternalFrame {
    ...
    void grabar() {
        ...
        try {
            detalleC.registrarDetalleOrganizacionCompetencia(pais.getPaisId(),idCompetencia);
            AlertaBien bien = new AlertaBien("Mensaje", "Se registró correctamente el detalle");
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("REGISTRAR DETALLE ORGANIZACIÓN COMPETENCIA");
