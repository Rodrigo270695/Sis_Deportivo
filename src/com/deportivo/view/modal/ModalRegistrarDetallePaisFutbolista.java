...
import com.deportivo.view.FrmGestionarDetallePaisFutbolista;
...
public final class ModalRegistrarDetallePaisFutbolista extends javax.swing.JInternalFrame {

    DetallePaisFutbolistaController detalleC = new DetallePaisFutbolistaController();
    FutbolistaController futbolistaC = new FutbolistaController();
    public static PaisController tipoC = new PaisController();

    public static int idFutbolista2;

    public ModalRegistrarDetallePaisFutbolista() {
        initComponents();
        cargarPaises();
    }
    ...
    public static void cargarPaises() {
        ...
        List<Pais> lista = tipoC.listar();

        for (Pais tipoPro : lista) {
    ...
    void grabar() {
        ...
        Pais tipoP = (Pais) tipoC.obtenerdato(cbxTipo.getSelectedItem().toString());

        try {
            detalleC.registrarDetalle(idFutbolista2, tipoP.getPaisId());
            AlertaBien bien = new AlertaBien("Mensaje", "Se registró correctamente el detalle de país futbolista");
            FrmGestionarDetallePaisFutbolista.listar("");
            dispose();
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("REGISTRAR DETALLE PAÍS FUTBOLISTA");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            ModalRegistrarPais.activarPais2 = true;
