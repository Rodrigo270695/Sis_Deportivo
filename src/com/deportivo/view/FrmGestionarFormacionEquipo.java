...
import com.deportivo.view.modal.ModalRegistrarFormacionEquipo;
...
public class FrmGestionarFormacionEquipo extends javax.swing.JInternalFrame {

    public static FormacionEquipoController formacionEquipoC = new FormacionEquipoController();

    public FrmGestionarFormacionEquipo() {
        initComponents();
        listar("");
    }
    ...
    public static void listar(String texto) {
        ...
        if (txtBuscar.getText().length() == 0) {
            lista = formacionEquipoC.listar();
        } else {
            lista = formacionEquipoC.buscar(texto);
        }
        Object obj[] = new Object[5];

        for (int i = 0; i < lista.size(); i++) {
            formacionEquipo = (FormacionEquipo) lista.get(i);
            obj[0] = formacionEquipo.getFormacion_id();
            obj[1] = formacionEquipo.getDescripcion();
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("GESTIONAR FORMACIÓN EQUIPO");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        ModalRegistrarFormacionEquipo frm = new ModalRegistrarFormacionEquipo();
                ...
                switch (boton.getName()) {
                    case "btnEliminar" -> {
                        if (filas == 0) {//si no elije ninguna fila
                            Alerta alerta = new Alerta("Alerta", "Debe seleccionar un formacionEquipo");
                        } else {
                    ...
                    case "btnModificar" -> {
                        if (filas == 0) {//si no elije ninguna fila
                            ...
                            ModalRegistrarFormacionEquipo.idFormacionEquipo = id;
                            FrmMenuPrincipal.centrarVentana(new ModalRegistrarFormacionEquipo());
                            ModalRegistrarFormacionEquipo.btnGrabar.setText("Modificar");
                    ...
                    case "btnVer" -> {
                        if (filas == 0) {
                            ...
                            ModalRegistrarFormacionEquipo.vista = true;
                            ModalRegistrarFormacionEquipo.idFormacionEquipo = id;
                            FrmMenuPrincipal.centrarVentana(new ModalRegistrarFormacionEquipo());
                        }
                    }
