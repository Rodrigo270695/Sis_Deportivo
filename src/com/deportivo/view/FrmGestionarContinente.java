...
import com.deportivo.view.modal.ModalRegistrarContinente;
...
public class FrmGestionarContinente extends javax.swing.JInternalFrame {
    ...
    public static void listar(String texto) {
        ...
        if (txtBuscar.getText().length() == 0) {
            lista = continenteC.listar();
        } else {
            lista = continenteC.buscar(texto);
        }
        Object obj[] = new Object[6];

        for (int i = 0; i < lista.size(); i++) {
            continente = (Continente) lista.get(i);
            obj[0] = continente.getContinenteId();
            obj[1] = continente.getNombre();
            obj[2] = continente.getAbreviatura();
        ...
        tblListado.getColumnModel().getColumn(2).setPreferredWidth(200);
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        ModalRegistrarContinente frm = new ModalRegistrarContinente();
                ...
                switch (boton.getName()) {
                    case "btnEliminar" -> {
                        if (filas == 0) {//si no elije ninguna fila
                            Alerta alerta = new Alerta("Alerta", "Debe seleccionar un continente");
                        } else {
                    ...
                    case "btnModificar" -> {
                        if (filas == 0) {//si no elije ninguna fila
                            ...
                            ModalRegistrarContinente.idContinente = id;
                            FrmMenuPrincipal.centrarVentana(new ModalRegistrarContinente());
                            ModalRegistrarContinente.btnGrabar.setText("Modificar");
                    ...
                    case "btnVer" -> {
                        if (filas == 0) {
                            ...
                            ModalRegistrarContinente.vista = true;
                            ModalRegistrarContinente.idContinente = id;
                            FrmMenuPrincipal.centrarVentana(new ModalRegistrarContinente());
                        }
                    }
