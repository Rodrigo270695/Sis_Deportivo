...
import com.deportivo.controller.DetalleCompetenciaGrupoController;
...
import com.deportivo.view.modal.ModalRegistrarDetalleCompetenciaGrupo;
...
public class FrmGestionarDetalleCompetenciaGrupo extends javax.swing.JInternalFrame {

    public static DetalleCompetenciaGrupoController detalleC = new DetalleCompetenciaGrupoController();
    GrupoController tipoC = new GrupoController();
    public static int idProfesional;

    public FrmGestionarDetalleCompetenciaGrupo() {
        initComponents();
        listar("");
    }
    ...
    public static void listar(String texto) {
        ...
        DetalleCompetenciaGrupo detallePro = null;
        Grupo tipoP;
        detallePro = detalleC.listar(idProfesional);

        Object obj[] = new Object[2];

        for (int i = 0; i < detallePro.getTipoGrupo().size(); i++) {
            tipoP = detallePro.getTipoGrupo().get(i);
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("GESTIONAR DETALLE COMPETENCIA GRUPO");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        ModalRegistrarDetalleCompetenciaGrupo.idProfesional = idProfesional;
        ModalRegistrarDetalleCompetenciaGrupo frm = new ModalRegistrarDetalleCompetenciaGrupo();
                    ...
                    case "btnEliminar" -> {
                        if (filas == 0) {//si no elije ninguna fila
                            ...
                            if (opcion == 0) {
                                ...
                                Grupo tipoP = (Grupo) tipoC.obtenerdato(valor);

                                try {
                                    detalleC.eliminarDetalle(idProfesional, tipoP.getGrupoId());
