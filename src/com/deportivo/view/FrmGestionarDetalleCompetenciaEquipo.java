...
import com.deportivo.controller.DetalleCompetenciaEquipoController;
...
import com.deportivo.view.modal.ModalRegistrarDetalleCompetenciaEquipo;
import com.deportivo.vista.modal.alerts.*;
import java.awt.*;
import javax.swing.*;
import javax.swing.table.DefaultTableModel;

public class FrmGestionarDetalleCompetenciaEquipo extends javax.swing.JInternalFrame {

    public static DetalleCompetenciaEquipoController detalleC = new DetalleCompetenciaEquipoController();
    EquipoController equipoC = new EquipoController();
    public static int idCompetencia;

    public FrmGestionarDetalleCompetenciaEquipo() {
        initComponents();
        listar("");
    }
    ...
    public static void listar(String texto) {
        ...
        DetalleCompetenciaEquipo detallePro = null;
        Equipo equipo;
        detallePro = detalleC.listar(idCompetencia);

        Object obj[] = new Object[2];

        for (int i = 0; i < detallePro.getEquipo().size(); i++) {
            equipo = detallePro.getEquipo().get(i);

            obj[0] = equipo.getNombreCorto();
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("GESTIONAR DETALLE COMPETENCIA EQUIPO");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        ModalRegistrarDetalleCompetenciaEquipo.idCompetencia = idCompetencia;
        ModalRegistrarDetalleCompetenciaEquipo frm = new ModalRegistrarDetalleCompetenciaEquipo();
                    ...
                    case "btnEliminar" -> {
                        if (filas == 0) {//si no elije ninguna fila
                            ...
                            if (opcion == 0) {
                                ...
                                Equipo equipo = (Equipo) equipoC.obtenerdato(valor);

                                try {
                                    detalleC.eliminarDetalle(idCompetencia, equipo.getEquipoId());
