...
import com.deportivo.controller.reporte.Reporte_cinco;
...
public final class Reporte_5 extends javax.swing.JInternalFrame {

    Reporte_cinco rp = new Reporte_cinco();
    PaisController competenciaC = new PaisController();
    ...
    void cargarPaises() {
        ...
        List<Pais> lista = competenciaC.listar();

        for (Pais competencia : lista) {
            cboPais.addItem(competencia.getNombre());
        }
    ...
    void listar() {
        ...
        String columas[] = {"FUTBOLISTAS"};
        DefaultTableModel modelo = new DefaultTableModel();
        ResultSet rs = rp.listarPais(cboPais.getSelectedItem().toString());
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("LISTA DE FUTBOLISTAS POR PAIS");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(cboPais, javax.swing.GroupLayout.PREFERRED_SIZE, 289, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(btnAdd, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(192, 207, Short.MAX_VALUE))
