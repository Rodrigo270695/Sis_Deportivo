...
public final class Reporte_1 extends javax.swing.JInternalFrame {
    ...
    void listar() {
        ...
        try {
            ...
            tblListado.getColumnModel().getColumn(3).setPreferredWidth(40);
            tblListado.getColumnModel().getColumn(4).setPreferredWidth(40);
            tblListado.getColumnModel().getColumn(5).setPreferredWidth(40);
            tblListado.getColumnModel().getColumn(6).setPreferredWidth(40);
            tblListado.getColumnModel().getColumn(7).setPreferredWidth(40);
            tblListado.getColumnModel().getColumn(8).setPreferredWidth(40);
