...
package com.deportivo.vista.modal.alerts;
...
public class AlertaBien extends javax.swing.JFrame {

    public AlertaBien(String titulo, String mensaje) {
        initComponents();
...
//        setIconImage(new ImageIcon(getClass().getResource("/compac/icono/general/logos.png")).getImage());
        ...
        //para el icono
        String path = "/com/deportivo/iconos/cerrar.png";
    ...
    public void muestraImagen() {
        String path = "/com/deportivo/iconos/Info_16px.png";
        URL url = this.getClass().getResource(path);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertaBien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlertaBien(null, null).setVisible(true);
            }
        });
    }
